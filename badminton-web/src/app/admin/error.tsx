  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="rounded-3xl border border-rose-200 bg-white p-6 shadow-lg">
        ...
        <h1 className="mt-4 text-2xl font-black text-zinc-950">Admin dashboard unavailable</h1>
        <p className="mt-3 text-sm leading-6 text-zinc-700">
          The admin dashboard could not load. Retry after checking the database connection.
        </p>
        <button
          type="button"
          onClick={reset}
